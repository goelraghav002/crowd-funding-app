...
const Profile = () => {
	...
	return (
		<>
			<div className='text-white mb-10 flex items-start'>
				<div className='mr-40'>
					<h4 className='font-bold text-[20px] my-2'>User Details</h4>
					...
					<p className='mt-3 text-white'>
						&nbsp;&nbsp;
						<span className='font-bold text-gray-400'>Gov Id Type: </span>
						{user?.govIdType}
					</p>
					<p className='mt-3 text-white'>
						&nbsp;&nbsp;
						<span className='font-bold text-gray-400'>Gov Id Number: </span>
						{user?.govIdNumber}
					</p>
				</div>
				<div>
					...
					<p className='mt-3 text-white'>
						&nbsp;&nbsp;
						<span className='font-bold text-gray-400'>Altername Number: </span>
						{user?.contact2}
					</p>
					<p className='mt-3 text-white'>
